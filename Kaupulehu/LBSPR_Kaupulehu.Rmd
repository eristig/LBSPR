...
colnames(SPR_wide)<-c("Option", "mm", "inches", FM_options)
nameIn<-paste0(MyParsList[[k]]$MyPars@Species, " - SPR Values")
nameSPR<-c(nameIn = 7)
...
colnames(YPR_wide)<-c("Option", "mm", "inches", FM_options)
options(knitr.kable.NA = "")
nameYPR<-c(nameIn = 7)
